/*Uma matriz A com tamanho mxm definida pelo usuario usando alocacao dinamica
A) Copiar todos elementos da diagonal para um vetor B
B) Declarar um vetor C que contenha a linha da matriz com maior media de elementos*/
